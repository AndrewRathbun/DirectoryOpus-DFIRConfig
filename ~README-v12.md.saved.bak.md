...
Write-Log -logFile $logFile -msg "Script Name: $scriptName"
	Write-Log -logFile $logFile -msg "Full Path: $scriptPath"
	Write-Log -logFile $logFile -msg "Last Modified Date: $($fileInfo.LastWriteTime)"
	Write-Log -logFile $logFile -msg "File Size: $fileSizeInBytes bytes | $fileSizeFormatted MB"
	Write-Log -logFile $logFile -msg "Certificate Expiration: $lastSignedTime"
	Write-Log -logFile $logFile -msg "SHA256 Hash: $fileHash"
	Write-Log -logFile $logFile -msg "--------- Script Log -----